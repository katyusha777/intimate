...
| `dashboard/` | ✓ AccountShell, SignInPrompt, ProfileEditorForm, MediaManager, VerificationFlow, OnboardingChecklist (the get-your-profile-live journey card per ONBOARDING.md §3), StatusBanner (the in-review and you're-live states), BecomeAdvertiserBanner (client dashboard "did you mean to advertise?" self-service switch) — anticipated: ImportWizard steps, StatsTiles |
