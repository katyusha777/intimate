...
export const SERVICE_SYNONYMS: Record<string, string> = {
  ...
  // massage-parlor menu names (kimnl et al) — marketing labels → canonical
  'couples massage': 'couples_massage',
  'partner massage': 'couples_massage',
  'stellen massage': 'couples_massage',
  'soft sm': 'soft_sm_massage',
  'soft sm massage': 'soft_sm_massage',
  'fifty shades': 'soft_sm_massage',
  'fifty shades of grey': 'soft_sm_massage',
  'fifty shades of grey massage': 'soft_sm_massage',
  'vip massage': 'erotic_massage',
  'olie massage': 'relaxing_massage',
  'oliemassage': 'relaxing_massage',
  'double pleasure': 'erotic_massage',
  '4 hands massage': 'four_hands_massage',
  'vierhandige massage': 'four_hands_massage',
